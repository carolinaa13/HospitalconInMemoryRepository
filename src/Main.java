...
public class Main {
    public static void main(String[] args) {
        //Creo un nuevo repositorio de memoria para el hospital
        InMemoryRepository<Hospital> hospitalRepository = new InMemoryRepository<>();
        ...
        try {
            ...
            Optional<Hospital> encontradaPorId = hospitalRepository.findById(1L);
